...
void setup() {
    ...
    player = minim.loadFile("itfaiye.mp3");       //Data dosyasında mevcut olan yagmur.mp3 isimli yağmur sesi 
...
void draw() {
    ...
    if (gelen_data == 1) {             //Eğer gelen data 1 ise  
        ...
        player.play();                  //İtfaiye sesi çıkart 
